...
- 회원 구분(누구의 코멘트인지·마이페이지)은 필수지만, 비밀번호 인증은 불필요 → **프로필 선택 입장** (D-003).
...
| #   | 화면               | 핵심 요소                                                                 | 레벨 |
| --- | ------------------ | ------------------------------------------------------------------------- | ---- |
| 1   | 입장 (프로필 선택) | 서비스 한 줄 소개 + 모임 멤버 프로필 그리드                               | Lv1  |
...
| 5   | 마이페이지         | 내 프로필·모임 정보 + 주문 목록(주문일·단계별 날짜)·상태(사용자 언어+진행 스텝)·구매 확정             | Lv2  |
...
1. **첫 진입 이해**: 프로필 선택 → 책방까지 "무엇을 하는 서비스인지" 즉시 전달, 빈 책방 온보딩
...
| ----------------------------- | --------------------------------------------------------------------- |
| Docker 1회 실행 + 더미데이터  | docker-compose up → 시드 자동 실행 → 프로필 선택만으로 즉시 탐색      |
